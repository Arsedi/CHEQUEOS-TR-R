                  ...
                  {(()=>{
                    ...
                    return (
                      <>
                        ...
                        {sel && (()=>{
                          const e2=sel.curso?{c:"#3498db",t:"En curso"}:(sel.e>sel.p?{c:"#2ecc71",t:"Cerró por encima (extra)"}:(sel.e===sel.p?{c:"#3498db",t:"Cerró justo"}:{c:"#f39c12",t:"Cerró por debajo (garantía)"}));
                          return (
