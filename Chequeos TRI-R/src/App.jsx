        ...
        <div style={{background:"linear-gradient(135deg,#1a0a0a 0%,#7a1510 45%,#c0392b 100%)",padding:"22px 20px 18px",position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
            ...
            <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:6}}>
              <div style={{fontSize:10,color:"rgba(255,255,255,0.35)",letterSpacing:1,marginTop:4}}>v3.0</div>
                  ...
                  {(()=>{
                    ...
                    return (
                      <>
                        ...
                        {sel && (()=>{
                          const e2=sel.curso?{c:"#3498db",t:"En curso"}:(sel.e>sel.p?{c:"#2ecc71",t:"▲ Extra"}:(sel.e===sel.p?{c:"#3498db",t:"Justo"}:{c:"#f39c12",t:"▼ Garantía"}));
                          return (
                            <div style={{background:"#0f1923",border:"1px solid #2d3f52",borderRadius:12,padding:"12px 14px",marginTop:14}}>
                              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
                                ...
                                {sel.curso && <span style={{fontSize:9.5,fontWeight:800,color:"#3498db",background:"#3498db22",border:"1px solid #3498db55",borderRadius:20,padding:"2px 9px",letterSpacing:0.5}}>ACTUAL</span>}
                              </div>
        ...
        {view==="comparativo" && isAdmin && (()=>{
          ...
          function filasPara(ano,mes,soloAno){
            return adminData.map(u=>{
              ...
              const prog = regs.reduce((s,r)=>s+totU(r.prog),0);
