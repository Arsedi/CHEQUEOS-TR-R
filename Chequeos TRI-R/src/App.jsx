                              ...
                              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                                ...
                                <div style={{textAlign:"right"}}>
                                  ...
                                  {r.log&&r.log.length>0&&(
                                    <div style={{marginTop:10,borderTop:"1px solid #1e2d3d",paddingTop:10}}>
                                      <div style={{fontSize:11,color:"#7a8fa6",textTransform:"uppercase",letterSpacing:1,marginBottom:6}}>Entradas registradas</div>
