...
const CATS = [
  { id:"trir",    nombre:"TRI-R",       unidad:"sector", color:"#3498db", codigos:"CRI · CRA · CRNU · CRF · LRC · CRQA · LRQA · CRAV · EBTFU" },
  { id:"ed",      nombre:"ED",          unidad:"sector", color:"#9b59b6", codigos:"ED (ida y vuelta = 1) · CHK" },
  { id:"profrec", nombre:"PROF/REC",    unidad:"sesion", color:"#f39c12", codigos:"PROF · REC" },
  { id:"rnpsim",  nombre:"RNP/RQA/SIM", unidad:"sesion", color:"#1abc9c", codigos:"SIM · UPRT · RQA · RNP" },
  { id:"ftd",     nombre:"FTD/TIERRA",  unidad:"sesion", color:"#e67e22", codigos:"FTD" },
  { id:"crm",     nombre:"CRM",         unidad:"sesion", color:"#2ecc71", codigos:"CRM" },
];
